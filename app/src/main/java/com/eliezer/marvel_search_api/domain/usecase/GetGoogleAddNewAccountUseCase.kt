...
class GetGoogleAddNewAccountUseCase @Inject constructor(
    @IoDispatcher dispatcher: CoroutineDispatcher,
    private val firebaseRepository: FirebaseRepository
) : BaseFlowUseCase<Context, Result<UserAccount>>(dispatcher){
    override fun execute(params: Context): Flow<Result<UserAccount>> = firebaseRepository.signInAddGoogleNewAccount(params)
}